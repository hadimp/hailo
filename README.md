...
<div align="center">
  <h3>A faster way to type using only directional inputs.</h3>
  <p>Designed for Smart TVs, Game Consoles, and VR devices.</p>

  <video src="video/typing_w_hailo.mp4" width="100%" controls></video>
</div>
...
- **🔼◀️▶️ Select (Up, Left, Right):** Instantly type the letter in the corresponding directional slot.
- **🎯 Space (Enter/Center):** Submit a space.
- **✖️ Delete (Long-press Down):** Quickly clear characters.
